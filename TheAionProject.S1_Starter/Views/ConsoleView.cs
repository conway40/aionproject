...
namespace TheAionProject
{
    ...
    public class ConsoleView
    {
        ...
        /// <summary>
        /// get a character skin tone from the user
        /// </summary>
        /// <returns>character skin tone value</returns>
        public Traveler.SkinTone GetSkin()
        {
            Traveler.SkinTone skinTone;
            Enum.TryParse<Traveler.SkinTone>(Console.ReadLine(), out skinTone);
        ...
        public Traveler GetInitialTravelerInfo()
        {
            ...
            //
            // get traveler's skin tone
            //
            DisplayGamePlayScreen("Mission Initialization - Skin Tone", Text.InitializeMissionGetTravelerSkin(traveler), ActionMenu.MissionIntro, "");
            DisplayInputBoxPrompt($"Enter your skin tone, {traveler.Name}: ");
            traveler.Skin = GetSkin();
            ...
            //
            // get traveler's life status
            //
            DisplayGamePlayScreen("Mission Initialization - Life Status", Text.InitializeMissionGetTravelerLifeStatus(traveler), ActionMenu.MissionIntro, "");
            DisplayInputBoxPrompt("Are you alive? (Yes or No)");
            traveler.IsLiving = GetBool();
