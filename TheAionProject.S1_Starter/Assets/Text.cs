...
namespace TheAionProject
{
    ...
    public static class Text
    {
        ...
        public static string InitializeMissionGetTravelerSkin(Traveler gameTraveler)
        {
            string messageBoxText =
                $"{gameTraveler.Name}, we will need your skin tone for this mission.\n" +
                " \n" +
                "Enter your skin tone below.\n" +
                " \n" +
                "Please use the one of the colors below." +
                " \n";

            string skinToneList = null;

            foreach (Traveler.SkinTone skin in Enum.GetValues(typeof(Traveler.SkinTone)))
            {
                if (skin != Traveler.SkinTone.None)
                {
                    skinToneList += $"\t{skin}\n";
                }
            }

            messageBoxText += skinToneList;
        ...
        public static string InitializeMissionGetTravelerLifeStatus(Traveler gameTraveler)
        {
            string messageBoxText =
                $"{gameTraveler.Name}, are you alive?\n" +
                " \n";
        ...
        public static string InitializeMissionEchoTravelerInfo(Traveler gameTraveler)
        {
            string messageBoxText =
                ...
                $"\tTraveler Skin Tone: {gameTraveler.Skin}\n" +
                $"\tTraveler Home Planet: {gameTraveler.HomePlanet}\n" +
                $"\tTraveler Is Alive: {gameTraveler.IsLiving}\n" +
                " \n" +
        ...
        public static string TravelerInfo(Traveler gameTraveler)
        {
            string messageBoxText =
                ...
                $"\tTraveler Catchphrase: {gameTraveler.Catchphrase()}\n" +
                $"\tTraveler Is Alive: {gameTraveler.IsLiving}\n" +
                " \n";
